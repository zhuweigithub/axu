...
<section>
	<div class="fabuBox">
		...
		<div class="secretIntro">
			...
			<textarea placeholder="说点什么暗示一下你的小伙伴~~"></textarea>
		</div>
		...
		<button class="fabu" onclick="fabu()">发布</button>
